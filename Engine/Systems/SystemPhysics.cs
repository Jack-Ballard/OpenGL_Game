...
namespace OpenGL_Game.Engine.Systems
{
    class SystemPhysics : System
    {
        ...
        public SystemPhysics()
        {
            ...
            LoadShader("Engine/Shaders/single-light.vert", ShaderType.VertexShader, pgmID, out vsID);
            LoadShader("Engine/Shaders/single-light.frag", ShaderType.FragmentShader, pgmID, out fsID);
        ...
        public void Motion(ref ComponentPosition position, ref ComponentVelocity velocity)
        {
