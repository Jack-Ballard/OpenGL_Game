...
namespace OpenGL_Game.Engine.OBJLoader
{
    ...
    {
        List<GeoGroup> groups = new List<GeoGroup>();
        ...
        public void LoadObject(string filename)
        {
            try
            {
                ...
                LoadResult obj = LoadOBJObject(filename);
                ...
                foreach (var group in obj.Groups)
                {
                    ...
                    {
                        newGroup.texture = ResourceManager.LoadTexture("Game\\Geometry\\Default\\default.png");
                    }
                    bool error = false;
                    string errorMessage = "";
                    ...
                    GL.BufferData(BufferTarget.ArrayBuffer, (nint)(newGroup.vertices.Count * 4), newGroup.vertices.ToArray<float>(), BufferUsageHint.StaticDraw);
                    ...
                    if (obj.Textures.Count > 0)
                    {
                        ...
                        GL.BufferData(BufferTarget.ArrayBuffer, (nint)(newGroup.textureCoords.Count * 4), newGroup.textureCoords.ToArray<float>(), BufferUsageHint.StaticDraw);
                    ...
                    if (obj.Normals.Count > 0)
                    {
                        ...
                        GL.BufferData(BufferTarget.ArrayBuffer, (nint)(newGroup.normals.Count * 4), newGroup.normals.ToArray<float>(), BufferUsageHint.StaticDraw);
